                    ...
                    if key.startswith("_____"):
                        ...
                        if type(data[x][key]) is list:
                            if len(data[x][key[1:]]) > 0:
                                table += self.make_header("{}:{}".format(x,key[1:]).upper())
