...
class QBCreditcards:
    ...
    @verbose(True,verbose_flag,verbose_timeout,"Finding American Express Card patterns")
    ...
    @verbose(True,verbose_flag,verbose_timeout,"Finding Visa Card patterns")
    def visa(self,data):
        '''
    ...
    @verbose(True,verbose_flag,verbose_timeout,"Finding Master Card patterns")
    ...
    @verbose(True,verbose_flag,verbose_timeout,"Finding Discover Card patterns")
    ...
    @verbose(True,verbose_flag,verbose_timeout,"Finding Jcb Card patterns")
    def jcb(self,data):
        '''
    ...
    @verbose(True,verbose_flag,verbose_timeout,"Finding Diners Club Card patterns")
