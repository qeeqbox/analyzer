...
This project automates the daily tasks of Threat Intelligence Analyzer role locally. It analyzes, visualizes and structures **sensitive** files or data (without external resources' interaction) by extracting features, artifacts and IoC using different modules. The output of those modules can be easily integrated in your research or SOC platforms.
